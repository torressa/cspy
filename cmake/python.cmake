...
if(BUILD_TESTING)
  add_custom_target(python_setup ALL
	# Make appropriate folder structure
    COMMAND ${CMAKE_COMMAND} -E make_directory cspy cspy/.libs
    COMMAND ${CMAKE_COMMAND} -E make_directory cspy/algorithms/
	# copy setup file generated by cmake
    ...
    COMMAND ${CMAKE_COMMAND} -E $<IF:$<BOOL:${UNIX}>,copy,true> $<TARGET_FILE:BiDirectionalCpp> cspy/algorithms/
	...
	COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_BINARY_DIR}/python/*.py cspy/algorithms/
